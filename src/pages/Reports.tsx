...
export function Reports() {
  const { transactions, tasks, budgets, savingsGoals } = useApp();
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-5 shadow-sm border dark:border-gray-700">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">Tỷ lệ tiết kiệm</span>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-5 shadow-sm border dark:border-gray-700">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">Hoàn thành CV</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border dark:border-gray-700">
          ...
          {categoryData.length === 0 ? (
            <div className="flex items-center justify-center h-[280px] text-gray-500 dark:text-gray-400">Chưa có dữ liệu</div>
          ) : (
            <ResponsiveContainer width="100%" height={280}>
              <PieChart>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border dark:border-gray-700">
          ...
          {budgets.length === 0 ? (
            <p className="text-gray-500 dark:text-gray-400 text-sm">Chưa có ngân sách</p>
          ) : budgets.map(b => {
            ...
            return (
              <div key={b.id} className="mb-4">
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-gray-500 dark:text-gray-400">{b.spent.toLocaleString('vi-VN')} / {b.limit.toLocaleString('vi-VN')} ₫</span>
                </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border dark:border-gray-700">
          ...
          {savingsGoals.length === 0 ? (
            <p className="text-gray-500 dark:text-gray-400 text-sm">Chưa có quỹ</p>
          ) : savingsGoals.map(g => {
            ...
            return (
              <div key={g.id} className="mb-4">
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-gray-500 dark:text-gray-400">{g.current.toLocaleString('vi-VN')} / {g.target.toLocaleString('vi-VN')} ₫</span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
